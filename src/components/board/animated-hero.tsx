  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="inline-flex items-center gap-1.5 rounded-pill border border-gold/30 bg-gold-bg px-2 py-0.5 text-[7px] font-bold uppercase tracking-widest text-gold-ink"
      >
        Southern California · Rec, Club & High School
      </motion.span>
      <h1 className="mt-0.5 font-display text-base font-extrabold leading-[1.2] tracking-tight text-ink sm:text-lg">
        Find your next scrimmage before the whistle blows.
      </h1>
      <p className="mt-0.5 mx-auto max-w-md text-[10px] text-ink-2">
